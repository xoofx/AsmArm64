...
partial class Arm64InstructionDecoderTable
{
    ...
    public static ReadOnlySpan<byte> Buffer => new byte[58380]
    {
        ...
        33,18,0,0,0,0,0,0,                  // Xd|SP    - w
        17,18,0,5,0,0,0,0,                  // Xn|SP    - r
        21,1,4,1,16,6,0,0,                  // uimm6    - r
        21,1,0,1,10,4,0,0,                  // uimm4    - r
        ...
        21,0,12,0,4,0,129,2,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        22,1,21,2,5,19,29,2,                // label    - r
        // ADRP_only_pcreladdr            - ADRP        Xd, label
        22,0,13,0,4,0,129,2,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        22,4,21,2,5,19,29,2,                // label    - r
        ...
        45,0,29,0,6,55,128,0,
        // AUTIASP_hi_hints               - AUTIASP    
        46,0,31,0,6,55,128,0,
        // AUTIAZ_hi_hints                - AUTIAZ     
        47,0,34,0,6,55,128,0,
        // AUTIA171615_64lr_dp_1src       - AUTIA171615
        48,0,30,0,4,56,128,0,
        // AUTIASPPC_only_dp_1src_imm     - AUTIASPPC   label
        49,0,32,0,4,56,129,1,
        22,3,16,1,5,16,0,0,                 // label    - r
        ...
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,0,1,16,6,0,0,                  // immr     - r
        21,1,0,1,10,6,0,0,                  // imms     - r
        ...
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,0,1,16,6,0,0,                  // lsb      - r
        21,1,5,2,10,6,16,6,                 // width    - r
        ...
        200,0,145,0,6,12,128,0,
        // CLREX_bn_barriers              - CLREX       {#imm}
        201,0,146,0,6,0,128,1,
        149,129,0,1,8,4,0,0,                // imm?     - r
        ...
        100,1,31,1,4,0,128,3,
        33,20,0,0,0,0,0,0,                  // Wd|WSP   - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,15,1,10,12,0,0,                // imm      - r
        // EOR_64_log_imm                 - EOR         Xd|SP, Xn, #imm
        101,1,31,1,4,0,128,3,
        33,18,0,0,0,0,0,0,                  // Xd|SP    - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,16,1,10,13,0,0,                // imm      - r
        ...
        104,1,33,1,6,0,128,0,
        // ERETAA_64e_branch_reg          - ERETAA     
        105,1,34,1,4,55,128,0,
        // ERETAB_64e_branch_reg          - ERETAB     
        106,1,35,1,4,55,128,0,
        // ESB_hi_hints                   - ESB        
        107,1,36,1,6,58,128,0,
        // EXTR_32_extract                - EXTR        Wd, Wn, Wm, #lsb
        108,1,38,1,4,0,128,4,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        17,19,0,16,0,0,0,0,                 // Wm       - r
        21,1,0,1,10,6,0,0,                  // lsb      - r
        // EXTR_64_extract                - EXTR        Xd, Xn, Xm, #lsb
        109,1,38,1,4,0,128,4,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        17,17,0,16,0,0,0,0,                 // Xm       - r
        21,1,0,1,10,6,0,0,                  // lsb      - r
        ...
        121,1,147,1,6,0,128,1,
        21,1,0,1,5,7,0,0,                   // imm      - r
        // HLT_ex_exception               - HLT         #imm
        122,1,148,1,6,0,128,1,
        21,1,0,1,5,16,0,0,                  // imm      - r
        // HVC_ex_exception               - HVC         #imm
        123,1,149,1,6,0,128,1,
        21,1,0,1,5,16,0,0,                  // imm      - r
        ...
        126,1,153,1,6,0,128,1,
        149,133,0,1,8,4,0,0,                // option?  - r
        ...
        207,1,5,2,4,53,128,2,
        33,17,0,0,0,0,0,0,                  // Xt       - w
        20,6,165,68,12,9,0,0,               // src      - r
        ...
        156,2,117,2,4,0,128,3,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,8,1,16,6,0,0,                  // shift    - r
        // LSL_ubfm_64m_bitfield          - LSL         Xd, Xn, #shift
        157,2,117,2,4,0,128,3,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,9,1,16,6,0,0,                  // shift    - r
        ...
        162,2,119,2,4,0,128,3,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,0,1,16,6,0,0,                  // shift    - r
        // LSR_ubfm_64m_bitfield          - LSR         Xd, Xn, #shift
        163,2,119,2,4,0,128,3,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,0,1,16,6,0,0,                  // shift    - r
        ...
        173,2,128,2,4,0,128,2,
        33,20,0,0,0,0,0,0,                  // Wd|WSP   - w
        21,1,15,1,10,12,0,0,                // imm      - r
        // MOV_orr_64_log_imm             - MOV         Xd|SP, #imm
        174,2,128,2,4,0,128,2,
        33,18,0,0,0,0,0,0,                  // Xd|SP    - w
        21,1,16,1,10,13,0,0,                // imm      - r
        // MOV_movn_32_movewide           - MOV         Wd, #imm
        175,2,128,2,4,0,128,2,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        21,1,19,2,5,16,21,2,                // imm      - r
        // MOV_movn_64_movewide           - MOV         Xd, #imm
        176,2,128,2,4,0,128,2,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        21,1,21,2,5,16,21,2,                // imm      - r
        ...
        212,2,149,2,4,0,128,3,
        33,20,0,0,0,0,0,0,                  // Wd|WSP   - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,15,1,10,12,0,0,                // imm      - r
        // ORR_64_log_imm                 - ORR         Xd|SP, Xn, #imm
        213,2,149,2,4,0,128,3,
        33,18,0,0,0,0,0,0,                  // Xd|SP    - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,16,1,10,13,0,0,                // imm      - r
        ...
        67,3,2,3,4,34,128,3,
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,0,1,15,6,0,0,                  // shift    - r
        21,1,0,1,0,4,0,0,                   // mask     - r
        // ROR_extr_32_extract            - ROR         Wd, Ws, #shift
        68,3,3,3,4,0,128,3,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Ws       - r
        21,1,0,1,10,6,0,0,                  // shift    - r
        // ROR_extr_64_extract            - ROR         Xd, Xs, #shift
        69,3,3,3,4,0,128,3,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,17,0,5,0,0,0,0,                  // Xs       - r
        21,1,0,1,10,6,0,0,                  // shift    - r
        ...
        17,17,0,16,                         // Xs       - r
        // SEV_hi_hints                   - SEV        
        114,3,58,3,6,0,128,0,
        // SEVL_hi_hints                  - SEVL       
        115,3,59,3,6,0,128,0,
        ...
        117,3,92,3,4,16,128,3,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,128,1,10,8,0,0,                // simm     - r
        // SMAX_64_minmax_imm             - SMAX        Xd, Xn, #simm
        118,3,92,3,4,16,128,3,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,128,1,10,8,0,0,                // simm     - r
        ...
        132,3,146,3,6,0,128,0,
        // ST2G_64spost_ldsttags          - ST2G        Xt|SP, [Xn|SP], #simm
        133,3,158,3,4,53,128,3,
        17,18,0,0,0,0,0,0,                  // Xt|SP    - r
        36,2,165,0,0,0,0,0,                 // dst      - w
        21,1,132,1,12,9,0,0,                // simm     - r
        // ST2G_64spre_ldsttags           - ST2G        Xt|SP, [Xn|SP, #simm]!
        134,3,158,3,4,53,128,2,
        17,18,0,0,0,0,0,0,                  // Xt|SP    - r
        36,4,165,196,12,9,0,0,              // dst      - w
        // ST2G_64soffset_ldsttags        - ST2G        Xt|SP, [Xn|SP{, #simm}]
        135,3,158,3,4,53,128,2,
        17,18,0,0,0,0,0,0,                  // Xt|SP    - r
        36,6,165,68,12,9,0,0,               // dst      - w
        ...
        172,3,205,3,4,44,128,3,
        17,17,0,0,0,0,0,0,                  // Xt1      - r
        17,17,0,16,0,0,0,0,                 // Xt2      - r
        36,3,165,240,128,0,0,0,             // dst      - w
        ...
        180,3,210,3,4,44,128,2,
        17,19,0,0,0,0,0,0,                  // Wt       - r
        36,3,165,252,128,0,0,0,             // dst      - w
        // STLR_64s_ldapstl_writeback     - STLR        Xt, [Xn|SP, #-8]!
        181,3,210,3,4,44,128,2,
        ...
        196,3,221,3,4,0,128,3,
        17,19,0,0,0,0,0,0,                  // Wt1      - r
        17,19,0,10,0,0,0,0,                 // Wt2      - r
        36,6,165,66,15,7,0,0,               // dst      - w
        ...
        199,3,222,3,4,0,128,4,
        17,17,0,0,0,0,0,0,                  // Xt1      - r
        17,17,0,10,0,0,0,0,                 // Xt2      - r
        36,2,165,0,0,0,0,0,                 // dst      - w
        21,1,131,1,15,7,0,0,                // imm      - r
        // STP_32_ldstpair_pre            - STP         Wt1, Wt2, [Xn|SP, #imm]!
        200,3,222,3,4,0,128,3,
        17,19,0,0,0,0,0,0,                  // Wt1      - r
        17,19,0,10,0,0,0,0,                 // Wt2      - r
        36,4,165,194,15,7,0,0,              // dst      - w
        ...
        95,4,59,4,6,0,128,5,
        21,1,0,1,16,3,0,0,                  // op1      - r
        17,62,0,12,0,0,0,0,                 // Cn       - r
        17,62,0,8,0,0,0,0,                  // Cm       - r
        21,1,0,1,5,3,0,0,                   // op2      - r
        161,17,128,0,0,0,0,0,               // Xt?      - w
        ...
        97,4,61,4,6,73,128,5,
        21,1,0,1,16,3,0,0,                  // op1      - r
        17,62,0,12,0,0,0,0,                 // Cn       - r
        17,62,0,8,0,0,0,0,                  // Cm       - r
        21,1,0,1,5,3,0,0,                   // op2      - r
        161,17,192,0,0,0,0,0,               // Xt1?     - w
        // TBNZ_only_testbranch           - TBNZ        Rt, #imm, label
        98,4,63,4,4,0,129,3,
        33,21,0,0,2,0,0,0,                  // Rt       - w
        21,1,0,2,31,1,19,5,                 // imm      - r
        22,2,14,1,5,14,0,0,                 // label    - r
        ...
        100,4,66,4,6,76,128,1,
        21,1,0,1,5,16,0,0,                  // imm      - r
        // TCOMMIT_only_barriers          - TCOMMIT    
        101,4,67,4,6,76,128,0,
        ...
        122,4,100,4,4,16,128,3,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,0,1,10,8,0,0,                  // uimm     - r
        // UMAX_64u_minmax_imm            - UMAX        Xd, Xn, #uimm
        123,4,100,4,4,16,128,3,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,0,1,10,8,0,0,                  // uimm     - r
        ...
        126,4,103,4,4,16,128,3,
        33,19,0,0,0,0,0,0,                  // Wd       - w
        17,19,0,5,0,0,0,0,                  // Wn       - r
        21,1,0,1,10,8,0,0,                  // uimm     - r
        // UMIN_64u_minmax_imm            - UMIN        Xd, Xn, #uimm
        127,4,103,4,4,16,128,3,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        21,1,0,1,10,8,0,0,                  // uimm     - r
        ...
        143,4,159,4,6,55,128,0,
        // YIELD_hi_hints                 - YIELD      
        144,4,162,4,6,0,128,0,
        ...
        146,4,1,0,1,3,128,2,
        33,27,0,0,26,0,0,0,                 // Vd.T     - w
        17,27,0,5,26,0,0,0,                 // Vn.T     - r
        ...
        33,27,0,0,26,0,0,0,                 // Vd.T     - w
        17,27,0,5,26,0,0,0,                 // Vn.T     - r
        17,27,0,16,26,0,0,0,                // Vm.T     - r
        // ADDHN_asimddiff_n              - ADDHN       Vd.Tb, Vn.Ta, Vm.Ta
        149,4,6,0,1,3,128,3,
        33,27,0,0,31,0,0,0,                 // Vd.Tb    - w
        17,27,0,5,18,0,0,0,                 // Vn.Ta    - r
        17,27,0,16,18,0,0,0,                // Vm.Ta    - r
        // ADDHN2_asimddiff_n             - ADDHN2      Vd.Tb, Vn.Ta, Vm.Ta
        150,4,7,0,1,3,128,3,
        33,27,0,0,33,0,0,0,                 // Vd.Tb    - w
        17,27,0,5,18,0,0,0,                 // Vn.Ta    - r
        17,27,0,16,18,0,0,0,                // Vm.Ta    - r
        // ADDP_asisdpair_only            - ADDP        Dd, Vn.2D
        151,4,8,0,1,3,128,2,
        33,26,0,0,0,0,0,0,                  // Dd       - w
        17,27,0,5,55,0,0,0,                 // Vn.2D    - r
        ...
        153,4,11,0,1,3,128,2,
        33,22,0,0,4,0,0,0,                  // Vd       - w
        17,27,0,5,28,0,0,0,                 // Vn.T     - r
        // AESD_b_cryptoaes               - AESD        Vd.16B, Vn.16B
        154,4,14,0,1,1,128,2,
        33,27,0,0,53,0,0,0,                 // Vd.16B   - w
        17,27,0,5,53,0,0,0,                 // Vn.16B   - r
        // AESE_b_cryptoaes               - AESE        Vd.16B, Vn.16B
        155,4,15,0,1,1,128,2,
        33,27,0,0,53,0,0,0,                 // Vd.16B   - w
        17,27,0,5,53,0,0,0,                 // Vn.16B   - r
        // AESIMC_b_cryptoaes             - AESIMC      Vd.16B, Vn.16B
        156,4,16,0,1,1,128,2,
        33,27,0,0,53,0,0,0,                 // Vd.16B   - w
        17,27,0,5,53,0,0,0,                 // Vn.16B   - r
        // AESMC_b_cryptoaes              - AESMC       Vd.16B, Vn.16B
        157,4,17,0,1,1,128,2,
        33,27,0,0,53,0,0,0,                 // Vd.16B   - w
        17,27,0,5,53,0,0,0,                 // Vn.16B   - r
        // AND_asimdsame_only             - AND         Vd.T, Vn.T, Vm.T
        158,4,18,0,1,3,128,3,
        33,27,0,0,9,0,0,0,                  // Vd.T     - w
        17,27,0,5,9,0,0,0,                  // Vn.T     - r
        17,27,0,16,9,0,0,0,                 // Vm.T     - r
        // BCAX_vvv16_crypto4             - BCAX        Vd.16B, Vn.16B, Vm.16B, Va.16B
        159,4,47,0,1,65,128,4,
        33,27,0,0,53,0,0,0,                 // Vd.16B   - w
        17,27,0,5,53,0,0,0,                 // Vn.16B   - r
        17,27,0,16,53,0,0,0,                // Vm.16B   - r
        17,27,0,10,53,0,0,0,                // Va.16B   - r
        // BF1CVTL_asimdmisc_v            - BF1CVTL     Vd.8H, Vn.Ta
        160,4,48,0,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,10,0,0,0,                 // Vn.Ta    - r
        // BF1CVTL2_asimdmisc_v           - BF1CVTL2    Vd.8H, Vn.Ta
        161,4,49,0,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,11,0,0,0,                 // Vn.Ta    - r
        // BF2CVTL_asimdmisc_v            - BF2CVTL     Vd.8H, Vn.Ta
        162,4,50,0,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,10,0,0,0,                 // Vn.Ta    - r
        // BF2CVTL2_asimdmisc_v           - BF2CVTL2    Vd.8H, Vn.Ta
        163,4,51,0,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,11,0,0,0,                 // Vn.Ta    - r
        ...
        165,4,54,0,1,8,128,2,
        33,27,0,0,8,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,58,0,0,0,                 // Vn.4S    - r
        // BFCVTN2_asimdmisc_4s           - BFCVTN2     Vd.Ta, Vn.4S
        166,4,55,0,1,8,128,2,
        33,27,0,0,13,0,0,0,                 // Vd.Ta    - w
        17,27,0,5,58,0,0,0,                 // Vn.4S    - r
        // BFDOT_asimdelem_e              - BFDOT       Vd.Ta, Vn.Tb, Vm.2H[index]
        167,4,56,0,1,8,128,3,
        33,27,0,0,5,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,7,0,0,0,                  // Vn.Tb    - r
        17,27,5,16,56,0,0,0,                // Vm.2H    - r
        // BFDOT_asimdsame2_d             - BFDOT       Vd.Ta, Vn.Tb, Vm.Tb
        168,4,56,0,1,8,128,3,
        33,27,0,0,5,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,7,0,0,0,                  // Vn.Tb    - r
        17,27,0,16,7,0,0,0,                 // Vm.Tb    - r
        // BFMLALB_asimdelem_f            - BFMLALB     Vd.4S, Vn.8H, Vm.H[index]
        169,4,59,0,1,8,128,3,
        33,27,0,0,58,0,0,0,                 // Vd.4S    - w
        17,27,0,5,59,0,0,0,                 // Vn.8H    - r
        17,59,10,16,51,0,0,0,               // Vm.H     - r
        // BFMLALT_asimdelem_f            - BFMLALT     Vd.4S, Vn.8H, Vm.H[index]
        170,4,60,0,1,8,128,3,
        33,27,0,0,58,0,0,0,                 // Vd.4S    - w
        17,27,0,5,59,0,0,0,                 // Vn.8H    - r
        17,59,10,16,51,0,0,0,               // Vm.H     - r
        // BFMLALB_asimdsame2_f           - BFMLALB     Vd.4S, Vn.8H, Vm.8H
        171,4,59,0,1,8,128,3,
        33,27,0,0,58,0,0,0,                 // Vd.4S    - w
        17,27,0,5,59,0,0,0,                 // Vn.8H    - r
        17,27,0,16,59,0,0,0,                // Vm.8H    - r
        // BFMLALT_asimdsame2_f           - BFMLALT     Vd.4S, Vn.8H, Vm.8H
        172,4,60,0,1,8,128,3,
        33,27,0,0,58,0,0,0,                 // Vd.4S    - w
        17,27,0,5,59,0,0,0,                 // Vn.8H    - r
        17,27,0,16,59,0,0,0,                // Vm.8H    - r
        // BFMMLA_asimdsame2_e            - BFMMLA      Vd.4S, Vn.8H, Vm.8H
        173,4,61,0,1,8,128,3,
        33,27,0,0,58,0,0,0,                 // Vd.4S    - w
        17,27,0,5,59,0,0,0,                 // Vn.8H    - r
        17,27,0,16,59,0,0,0,                // Vm.8H    - r
        // BIC_asimdimm_l_hl              - BIC         Vd.T, #imm8 {, LSL #amount}
        174,4,63,0,1,3,128,3,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        21,1,0,2,16,3,5,5,                  // imm8     - r
        151,6,0,45,0,0,0,0,                 // LSL?     - r
        // BIC_asimdimm_l_sl              - BIC         Vd.T, #imm8 {, LSL #amount}
        175,4,63,0,1,3,128,3,
        33,27,0,0,5,0,0,0,                  // Vd.T     - w
        21,1,0,2,16,3,5,5,                  // imm8     - r
        151,6,0,77,0,0,0,0,                 // LSL?     - r
        // BIC_asimdsame_only             - BIC         Vd.T, Vn.T, Vm.T
        176,4,63,0,1,3,128,3,
        33,27,0,0,9,0,0,0,                  // Vd.T     - w
        17,27,0,5,9,0,0,0,                  // Vn.T     - r
        17,27,0,16,9,0,0,0,                 // Vm.T     - r
        // BIF_asimdsame_only             - BIF         Vd.T, Vn.T, Vm.T
        177,4,65,0,1,3,128,3,
        33,27,0,0,9,0,0,0,                  // Vd.T     - w
        17,27,0,5,9,0,0,0,                  // Vn.T     - r
        17,27,0,16,9,0,0,0,                 // Vm.T     - r
        // BIT_asimdsame_only             - BIT         Vd.T, Vn.T, Vm.T
        178,4,66,0,1,3,128,3,
        33,27,0,0,9,0,0,0,                  // Vd.T     - w
        17,27,0,5,9,0,0,0,                  // Vn.T     - r
        17,27,0,16,9,0,0,0,                 // Vm.T     - r
        // BSL_asimdsame_only             - BSL         Vd.T, Vn.T, Vm.T
        179,4,80,0,1,3,128,3,
        33,27,0,0,9,0,0,0,                  // Vd.T     - w
        17,27,0,5,9,0,0,0,                  // Vn.T     - r
        17,27,0,16,9,0,0,0,                 // Vm.T     - r
        // CLS_asimdmisc_r                - CLS         Vd.T, Vn.T
        180,4,147,0,1,3,128,2,
        33,27,0,0,27,0,0,0,                 // Vd.T     - w
        17,27,0,5,27,0,0,0,                 // Vn.T     - r
        // CLZ_asimdmisc_r                - CLZ         Vd.T, Vn.T
        181,4,148,0,1,3,128,2,
        33,27,0,0,27,0,0,0,                 // Vd.T     - w
        17,27,0,5,27,0,0,0,                 // Vn.T     - r
        ...
        185,4,149,0,1,3,128,3,
        33,27,0,0,26,0,0,0,                 // Vd.T     - w
        17,27,0,5,26,0,0,0,                 // Vn.T     - r
        21,3,0,0,0,0,0,0,                   // 0        - r
        ...
        203,4,159,0,1,3,128,3,
        33,27,0,0,26,0,0,0,                 // Vd.T     - w
        17,27,0,5,26,0,0,0,                 // Vn.T     - r
        17,27,0,16,26,0,0,0,                // Vm.T     - r
        // CNT_asimdmisc_r                - CNT         Vd.T, Vn.T
        204,4,161,0,1,3,128,2,
        33,27,0,0,30,0,0,0,                 // Vd.T     - w
        17,27,0,5,30,0,0,0,                 // Vn.T     - r
        // DUP_asisdone_only              - DUP         Vd, Vn.T[index]
        205,4,28,1,1,3,128,2,
        33,22,0,0,13,0,0,0,                 // Vd       - w
        17,27,17,5,41,0,0,0,                // Vn.T     - r
        // DUP_asimdins_dv_v              - DUP         Vd.T, Vn.Ts[index]
        206,4,28,1,1,3,128,2,
        33,27,0,0,48,0,0,0,                 // Vd.T     - w
        17,27,17,5,41,0,0,0,                // Vn.Ts    - r
        // DUP_asimdins_dr_r              - DUP         Vd.T, Rn
        207,4,28,1,1,3,128,2,
        33,27,0,0,48,0,0,0,                 // Vd.T     - w
        17,21,0,5,14,0,0,0,                 // Rn       - r
        // EOR_asimdsame_only             - EOR         Vd.T, Vn.T, Vm.T
        208,4,31,1,1,3,128,3,
        33,27,0,0,9,0,0,0,                  // Vd.T     - w
        17,27,0,5,9,0,0,0,                  // Vn.T     - r
        17,27,0,16,9,0,0,0,                 // Vm.T     - r
        // EOR3_vvv16_crypto4             - EOR3        Vd.16B, Vn.16B, Vm.16B, Va.16B
        209,4,32,1,1,65,128,4,
        33,27,0,0,53,0,0,0,                 // Vd.16B   - w
        17,27,0,5,53,0,0,0,                 // Vn.16B   - r
        17,27,0,16,53,0,0,0,                // Vm.16B   - r
        17,27,0,10,53,0,0,0,                // Va.16B   - r
        // EXT_asimdext_only              - EXT         Vd.T, Vn.T, Vm.T, #index
        210,4,37,1,1,3,128,4,
        33,27,0,0,9,0,0,0,                  // Vd.T     - w
        17,27,0,5,9,0,0,0,                  // Vn.T     - r
        17,27,0,16,9,0,0,0,                 // Vm.T     - r
        21,2,0,13,0,0,0,0,                  // index    - r
        // F1CVTL_asimdmisc_v             - F1CVTL      Vd.8H, Vn.Ta
        211,4,39,1,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,10,0,0,0,                 // Vn.Ta    - r
        // F1CVTL2_asimdmisc_v            - F1CVTL2     Vd.8H, Vn.Ta
        212,4,40,1,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,11,0,0,0,                 // Vn.Ta    - r
        // F2CVTL_asimdmisc_v             - F2CVTL      Vd.8H, Vn.Ta
        213,4,41,1,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,10,0,0,0,                 // Vn.Ta    - r
        // F2CVTL2_asimdmisc_v            - F2CVTL2     Vd.8H, Vn.Ta
        214,4,42,1,1,26,128,2,
        33,27,0,0,59,0,0,0,                 // Vd.8H    - w
        17,27,0,5,11,0,0,0,                 // Vn.Ta    - r
        ...
        216,4,43,1,1,3,128,3,
        33,22,0,0,1,0,0,0,                  // Vd       - w
        17,22,0,5,1,0,0,0,                  // Vn       - r
        17,22,0,16,1,0,0,0,                 // Vm       - r
        // FABD_asimdsamefp16_only        - FABD        Vd.T, Vn.T, Vm.T
        217,4,43,1,1,5,128,3,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        17,27,0,16,7,0,0,0,                 // Vm.T     - r
        // FABD_asimdsame_only            - FABD        Vd.T, Vn.T, Vm.T
        218,4,43,1,1,3,128,3,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        17,27,0,16,14,0,0,0,                // Vm.T     - r
        ...
        222,4,44,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FABS_asimdmisc_r               - FABS        Vd.T, Vn.T
        223,4,44,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        20,5,57,1,1,23,128,4,
        33,27,0,0,35,0,0,0,                 // Vd.T     - w
        17,27,0,5,35,0,0,0,                 // Vn.T     - r
        17,27,0,16,35,0,0,0,                // Vm.T     - r
        21,2,0,10,0,0,0,0,                  // rotate   - r
        // FCMLA_advsimd_elt              - FCMLA       Vd.T, Vn.T, Vm.Ts[index], #rotate
        21,5,57,1,1,23,128,4,
        33,27,0,0,37,0,0,0,                 // Vd.T     - w
        17,27,0,5,37,0,0,0,                 // Vn.T     - r
        17,27,15,16,21,0,0,0,               // Vm.Ts    - r
        21,2,0,11,0,0,0,0,                  // rotate   - r
        ...
        79,5,66,1,1,3,128,2,
        33,27,0,0,2,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,16,0,0,0,                 // Vn.Tb    - r
        // FCVTL2_asimdmisc_l             - FCVTL2      Vd.Ta, Vn.Tb
        80,5,67,1,1,3,128,2,
        33,27,0,0,2,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,17,0,0,0,                 // Vn.Tb    - r
        ...
        106,5,69,1,1,3,128,2,
        33,22,0,0,1,0,0,0,                  // Vd       - w
        17,22,0,5,1,0,0,0,                  // Vn       - r
        // FCVTMU_asimdmiscfp16_r         - FCVTMU      Vd.T, Vn.T
        107,5,69,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FCVTMU_asimdmisc_r             - FCVTMU      Vd.T, Vn.T
        108,5,69,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        // FCVTN_asimdsame2_d             - FCVTN       Vd.Ta, Vn.Tb, Vm.Tb
        109,5,70,1,1,26,128,3,
        33,27,0,0,9,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,7,0,0,0,                  // Vn.Tb    - r
        17,27,0,16,7,0,0,0,                 // Vm.Tb    - r
        // FCVTN_asimdmisc_n              - FCVTN       Vd.Tb, Vn.Ta
        110,5,70,1,1,3,128,2,
        33,27,0,0,16,0,0,0,                 // Vd.Tb    - w
        17,27,0,5,2,0,0,0,                  // Vn.Ta    - r
        // FCVTN2_asimdmisc_n             - FCVTN2      Vd.Tb, Vn.Ta
        111,5,71,1,1,3,128,2,
        33,27,0,0,17,0,0,0,                 // Vd.Tb    - w
        17,27,0,5,2,0,0,0,                  // Vn.Ta    - r
        // FCVTN_asimdsame2_h             - FCVTN       Vd.Ta, Vn.4S, Vm.4S
        112,5,70,1,1,26,128,3,
        33,27,0,0,10,0,0,0,                 // Vd.Ta    - w
        17,27,0,5,58,0,0,0,                 // Vn.4S    - r
        17,27,0,16,58,0,0,0,                // Vm.4S    - r
        // FCVTN2_asimdsame2_h            - FCVTN2      Vd.Ta, Vn.4S, Vm.4S
        113,5,71,1,1,26,128,3,
        33,27,0,0,11,0,0,0,                 // Vd.Ta    - w
        17,27,0,5,58,0,0,0,                 // Vn.4S    - r
        17,27,0,16,58,0,0,0,                // Vm.4S    - r
        ...
        171,5,76,1,1,3,128,2,
        33,27,0,0,6,0,0,0,                  // Vd.Tb    - w
        17,27,0,5,55,0,0,0,                 // Vn.2D    - r
        // FCVTXN2_asimdmisc_n            - FCVTXN2     Vd.Tb, Vn.2D
        172,5,77,1,1,3,128,2,
        33,27,0,0,12,0,0,0,                 // Vd.Tb    - w
        17,27,0,5,55,0,0,0,                 // Vn.2D    - r
        ...
        189,5,78,1,1,3,128,3,
        33,22,0,0,12,0,0,0,                 // Vd       - w
        17,22,0,5,12,0,0,0,                 // Vn       - r
        21,2,0,18,0,0,0,0,                  // fbits    - r
        // FCVTZS_asimdshf_c              - FCVTZS      Vd.T, Vn.T, #fbits
        190,5,78,1,1,3,128,3,
        33,27,0,0,47,0,0,0,                 // Vd.T     - w
        17,27,0,5,47,0,0,0,                 // Vn.T     - r
        21,2,0,18,0,0,0,0,                  // fbits    - r
        ...
        211,5,79,1,1,3,128,3,
        33,22,0,0,12,0,0,0,                 // Vd       - w
        17,22,0,5,12,0,0,0,                 // Vn       - r
        21,2,0,18,0,0,0,0,                  // fbits    - r
        // FCVTZU_asimdshf_c              - FCVTZU      Vd.T, Vn.T, #fbits
        212,5,79,1,1,3,128,3,
        33,27,0,0,47,0,0,0,                 // Vd.T     - w
        17,27,0,5,47,0,0,0,                 // Vn.T     - r
        21,2,0,18,0,0,0,0,                  // fbits    - r
        ...
        220,5,80,1,1,5,128,3,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        17,27,0,16,7,0,0,0,                 // Vm.T     - r
        // FDIV_asimdsame_only            - FDIV        Vd.T, Vn.T, Vm.T
        221,5,80,1,1,3,128,3,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        17,27,0,16,14,0,0,0,                // Vm.T     - r
        // FDOT_asimdelem_g               - FDOT        Vd.Ta, Vn.Tb, Vm.2B[index]
        222,5,81,1,1,27,128,3,
        33,27,0,0,7,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,9,0,0,0,                  // Vn.Tb    - r
        17,59,10,16,54,0,0,0,               // Vm.2B    - r
        // FDOT_asimdsame2_d              - FDOT        Vd.Ta, Vn.Tb, Vm.Tb
        223,5,81,1,1,27,128,3,
        33,27,0,0,7,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,9,0,0,0,                  // Vn.Tb    - r
        17,27,0,16,9,0,0,0,                 // Vm.Tb    - r
        // FDOT_asimdelem_d               - FDOT        Vd.Ta, Vn.Tb, Vm.4B[index]
        224,5,81,1,1,28,128,3,
        33,27,0,0,5,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,9,0,0,0,                  // Vn.Tb    - r
        17,27,5,16,57,0,0,0,                // Vm.4B    - r
        // FDOT_asimdsame2_dd             - FDOT        Vd.Ta, Vn.Tb, Vm.Tb
        225,5,81,1,1,28,128,3,
        33,27,0,0,5,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,9,0,0,0,                  // Vn.Tb    - r
        17,27,0,16,9,0,0,0,                 // Vm.Tb    - r
        ...
        233,5,84,1,1,5,128,3,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        17,27,0,16,7,0,0,0,                 // Vm.T     - r
        // FMAX_asimdsame_only            - FMAX        Vd.T, Vn.T, Vm.T
        234,5,84,1,1,3,128,3,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        17,27,0,16,14,0,0,0,                // Vm.T     - r
        ...
        21,6,96,1,1,3,128,3,
        33,27,0,0,22,0,0,0,                 // Vd.T     - w
        17,27,0,5,22,0,0,0,                 // Vn.T     - r
        17,27,12,16,3,0,0,0,                // Vm.Ts    - r
        ...
        59,6,109,1,2,0,128,2,
        33,27,1,0,50,0,0,0,                 // Vd.D     - w
        17,17,0,5,0,0,0,0,                  // Xn       - r
        ...
        61,6,109,1,2,0,128,2,
        33,17,0,0,0,0,0,0,                  // Xd       - w
        17,27,1,5,50,0,0,0,                 // Vn.D     - r
        ...
        65,6,109,1,2,0,128,2,
        33,24,0,0,0,0,0,0,                  // Hd       - w
        21,1,7,1,13,8,0,0,                  // imm      - r
        // FMOV_s_floatimm                - FMOV        Sd, #imm
        66,6,109,1,2,0,128,2,
        33,25,0,0,0,0,0,0,                  // Sd       - w
        21,1,7,1,13,8,0,0,                  // imm      - r
        // FMOV_d_floatimm                - FMOV        Dd, #imm
        67,6,109,1,2,0,128,2,
        33,26,0,0,0,0,0,0,                  // Dd       - w
        21,1,7,1,13,8,0,0,                  // imm      - r
        // FMOV_asimdimm_h_h              - FMOV        Vd.T, #imm
        68,6,109,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        21,1,7,2,16,3,5,5,                  // imm      - r
        // FMOV_asimdimm_s_s              - FMOV        Vd.T, #imm
        69,6,109,1,1,3,128,2,
        33,27,0,0,5,0,0,0,                  // Vd.T     - w
        21,1,7,2,16,3,5,5,                  // imm      - r
        // FMOV_asimdimm_d2_d             - FMOV        Vd.2D, #imm
        70,6,109,1,1,3,128,2,
        33,27,0,0,55,0,0,0,                 // Vd.2D    - w
        21,1,7,2,16,3,5,5,                  // imm      - r
        ...
        81,6,111,1,1,5,128,3,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        17,27,0,16,7,0,0,0,                 // Vm.T     - r
        // FMUL_asimdsame_only            - FMUL        Vd.T, Vn.T, Vm.T
        82,6,111,1,1,3,128,3,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        17,27,0,16,14,0,0,0,                // Vm.T     - r
        ...
        94,6,113,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FNEG_asimdmisc_r               - FNEG        Vd.T, Vn.T
        95,6,113,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        130,6,124,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FRINTA_asimdmisc_r             - FRINTA      Vd.T, Vn.T
        131,6,124,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        135,6,125,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FRINTI_asimdmisc_r             - FRINTI      Vd.T, Vn.T
        136,6,125,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        140,6,126,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FRINTM_asimdmisc_r             - FRINTM      Vd.T, Vn.T
        141,6,126,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        145,6,127,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FRINTN_asimdmisc_r             - FRINTN      Vd.T, Vn.T
        146,6,127,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        150,6,128,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FRINTP_asimdmisc_r             - FRINTP      Vd.T, Vn.T
        151,6,128,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        155,6,129,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FRINTX_asimdmisc_r             - FRINTX      Vd.T, Vn.T
        156,6,129,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        160,6,130,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FRINTZ_asimdmisc_r             - FRINTZ      Vd.T, Vn.T
        161,6,130,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        175,6,134,1,1,5,128,2,
        33,27,0,0,7,0,0,0,                  // Vd.T     - w
        17,27,0,5,7,0,0,0,                  // Vn.T     - r
        // FSQRT_asimdmisc_r              - FSQRT       Vd.T, Vn.T
        176,6,134,1,1,3,128,2,
        33,27,0,0,14,0,0,0,                 // Vd.T     - w
        17,27,0,5,14,0,0,0,                 // Vn.T     - r
        ...
        183,7,6,3,1,3,128,3,
        33,27,0,0,45,0,0,0,                 // Vd.Tb    - w
        17,27,0,5,40,0,0,0,                 // Vn.Ta    - r
        21,2,0,15,0,0,0,0,                  // shift    - r
        // RSHRN2_asimdshf_n              - RSHRN2      Vd.Tb, Vn.Ta, #shift
        184,7,7,3,1,3,128,3,
        33,27,0,0,46,0,0,0,                 // Vd.Tb    - w
        17,27,0,5,40,0,0,0,                 // Vn.Ta    - r
        21,2,0,15,0,0,0,0,                  // shift    - r
        ...
        216,7,29,3,1,3,128,3,
        33,22,0,0,12,0,0,0,                 // Vd       - w
        17,22,0,5,12,0,0,0,                 // Vn       - r
        21,2,0,18,0,0,0,0,                  // fbits    - r
        // SCVTF_asimdshf_c               - SCVTF       Vd.T, Vn.T, #fbits
        217,7,29,3,1,3,128,3,
        33,27,0,0,47,0,0,0,                 // Vd.T     - w
        17,27,0,5,47,0,0,0,                 // Vn.T     - r
        21,2,0,18,0,0,0,0,                  // fbits    - r
        ...
        7,8,99,3,1,3,128,3,
        33,27,0,0,20,0,0,0,                 // Vd.Ta    - w
        17,27,0,5,38,0,0,0,                 // Vn.Tb    - r
        17,75,20,2,21,0,0,0,                // Vm.Ts    - r
        // SMLAL2_asimdelem_l             - SMLAL2      Vd.Ta, Vn.Tb, Vm.Ts[index]
        8,8,100,3,1,3,128,3,
        33,27,0,0,20,0,0,0,                 // Vd.Ta    - w
        17,27,0,5,39,0,0,0,                 // Vn.Tb    - r
        17,75,20,2,21,0,0,0,                // Vm.Ts    - r
        ...
        10,9,13,4,3,25,128,2,
        17,26,0,0,0,0,0,0,                  // Dt       - r
        36,6,165,64,12,9,0,0,               // dst      - w
        // STUR_q_ldst_unscaled           - STUR        Qt, [Xn|SP{, #simm}]
        11,9,13,4,3,25,128,2,
        17,28,0,0,0,0,0,0,                  // Qt       - r
        36,6,165,64,12,9,0,0,               // dst      - w
        ...
        66,9,96,4,1,20,128,3,
        33,27,0,0,5,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,9,0,0,0,                  // Vn.Tb    - r
        17,27,5,16,57,0,0,0,                // Vm.4B    - r
        // UDOT_asimdsame2_d              - UDOT        Vd.Ta, Vn.Tb, Vm.Tb
        67,9,96,4,1,20,128,3,
        33,27,0,0,5,0,0,0,                  // Vd.Ta    - w
        17,27,0,5,9,0,0,0,                  // Vn.Tb    - r
        17,27,0,16,9,0,0,0,                 // Vm.Tb    - r
