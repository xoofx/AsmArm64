# AsmArm64 — Codex Agent Instructions
...
- Library: `src/AsmArm64/`
- The code generator: `src/AsmArm64.CodeGen/`
- Tests: `src/AsmArm64.Tests/` (MSTest)
- The benchmarks: `src/AsmArm64.Bench/`
